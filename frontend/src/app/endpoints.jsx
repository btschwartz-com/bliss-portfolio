...
const api_endpoints = {
    navbar: 'https://api.btschwartz.com/api/v1/portfolio/navbar',
    home: 'https://api.btschwartz.com/api/v1/portfolio/home',
    social: 'https://api.btschwartz.com/api/v1/portfolio/social',
    about: 'https://api.btschwartz.com/api/v1/portfolio/about',
    education: 'https://api.btschwartz.com/api/v1/portfolio/education',
    experiences: 'https://api.btschwartz.com/api/v1/portfolio/experiences',
    projects: 'https://api.btschwartz.com/api/v1/portfolio/projects',
    contact: 'https://api.btschwartz.com/api/v1/portfolio/contact',
};
